...
1. [第七课问题收集](https://shimo.im/docs/6dWdxhYxHVvq8qRq)
2. [第八课问题收集](https://shimo.im/docs/hYH9yQkrjPyYG6yK)
...
* [阿里技术专家详解DDD系列 - Domain Primitive](https://blog.csdn.net/chikuai9995/article/details/100723540)
...
* [DDD 实践手册(2. 实现分层架构)](https://zhuanlan.zhihu.com/p/105648986)
* [DDD 实践手册(3. Entity, Value Object)](https://zhuanlan.zhihu.com/p/106634373)
* [DDD 实践手册(4. Aggregate — 聚合)](https://zhuanlan.zhihu.com/p/107347593)
* [DDD 实践手册(5. Factory 与 Repository)](https://zhuanlan.zhihu.com/p/109048532)
* [DDD 实践手册(6. Bounded Context - 限界上下文)](https://zhuanlan.zhihu.com/p/110252394)
...
* [01、DDD和微服务的关系](https://www.jianshu.com/p/dfa427762975)
* [当中台遇上DDD，我们该如何设计微服务？](https://www.jianshu.com/p/5732b69bd1a1)
* [领域驱动设计系列文章（1）——通过现实例子显示领域驱动设计的威力](https://www.cnblogs.com/qixuejia/p/10789612.html)
* [领域驱动设计系列文章（2）——浅析VO、DTO、DO、PO的概念、区别和用处](https://www.cnblogs.com/qixuejia/p/4390086.html)
* [领域驱动设计系列文章（3）——有选择性的使用领域驱动设计](https://www.cnblogs.com/qixuejia/p/10789621.html)
* [区分 Protobuf 中缺失值和默认值](https://zhuanlan.zhihu.com/p/46603988)
* [Protocol Buffers wrappers src](https://github.com/protocolbuffers/protobuf/blob/master/src/google/protobuf/wrappers.proto)
...
* [A sample layout for Go application projects with the real code](https://github.com/zitryss/go-sample)
...
* [DTO to Entity and Entity to DTO Conversion](https://www.appsdeveloperblog.com/dto-to-entity-and-entity-to-dto-conversion/)
...
* [A GoMock Quick Start Guide](https://medium.com/better-programming/a-gomock-quick-start-guide-71bee4b3a6f1)
